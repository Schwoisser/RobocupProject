...
def dance4():
    ...
    names.append("HeadPitch")
    times.append([0.16, 0.96, 1.76, 2.56, 3.36, 4.16, 4.96])
    keys.append([-0.161711, -0.161711, -0.161711, -0.160616, -0.161711, -0.160616, -0.160616])

    names.append("HeadYaw")
    times.append([0.16, 0.96, 1.76, 2.56, 3.36, 4.16, 4.96])
    keys.append([-0.0788623, -0.922569, -0.0848661, 0.758921, -0.0848661, -0.124136, -0.077879])

    names.append("LAnklePitch")
    times.append([0.16, 0.96, 1.76, 2.56, 3.36, 4.16])
    ...
    names.append("LShoulderPitch")
    times.append([0.16, 0.96, 1.76, 2.56, 3.36, 4.16, 4.96])
    keys.append([-0.0991988, -0.10472, -0.106185, -0.240071, -0.106185, -0.106534, -0.11276])
...
def dance5():
    ...
    names.append("HeadPitch")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-0.000672507, -0.000672507, -0.000672507, -0.231865, -0.222498, -0.228495, -0.228495, -0.222816, -0.228495,
         -0.230342, -0.228495, -0.226552, -0.170989])

    names.append("HeadYaw")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [0, 0, 0, 0.0181209, 0.0173867, 0.0171171, 0.0167786, 0.016399, 0.0167786, 0.0167786, 0.016399, 0.016399,
         0.00558785])

    names.append("LAnklePitch")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-0.348279, -0.174185, -0.171502, -0.164061, -0.167552, -0.404916, -0.161303, -0.407489, -0.40182, -0.167108,
         -0.172115, -0.395586, 0.078972])

    names.append("LAnkleRoll")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-0.000469331, -0.0485521, -0.0522367, -0.0628318, -0.0610865, -0.0616461, -0.061869, -0.061869, -0.0616281,
         -0.0611527, -0.0616281, -0.070956, -0.107509])

    names.append("LElbowRoll")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-1.00705, -0.942478, -0.947551, -1.26422, -1.26141, -1.34842, -1.27056, -1.33812, -1.3374, -1.32876, -1.32994,
         -1.33012, -1.26388, -0.419876])

    names.append("LElbowYaw")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-1.38754, -1.37183, -1.36987, 0.457252, 0.450838, -1.30851, 0.449817, -1.30209, -1.30316, -1.29725, -1.54985,
         -1.5493, 0.315294, -1.2006])

    names.append("LHand")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [0.26, 0.26, 0.262901, 0.267093, 0.271569, 0.272798, 0.263606, 0.263606, 0.263606, 0.263606, 0.26, 0.263606,
         0.260375, 0.293589])

    names.append("LHipPitch")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-0.447738, -0.21201, -0.208418, -0.197222, -0.204204, -1.11177, -0.203015, -1.10724, -1.10724, -0.176278,
         -0.179532, -1.10174, 0.12602])

    names.append("LHipRoll")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [0.000504357, 0.0546468, 0.0584526, 0.0680678, 0.0680678, 0.0687065, 0.0674716, 0.0677568, 0.0675128, 0.0671775,
         0.0669856, 0.0763273, 0.110183])

    names.append("LHipYawPitch")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append([-0.000546386, -0.191061, -0.190223, -0.188496, -0.181514, -0.141372, -0.175975, -0.148155, -0.151908,
                 -0.150098, -0.155616, -0.148661, -0.162735])

    names.append("LKneePitch")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [0.696854, 0.363943, 0.363941, 0.361283, 0.359538, 1.43117, 0.358737, 1.42615, 1.42615, 0.415388, 0.418919,
         1.43093, -0.0905938])

    names.append("LShoulderPitch")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append([0.244346, 0.911062, 0.914764, 0.675238, 0.677544, -0.303813, 0.666206, -0.301066, -0.301525, -0.300513,
                 -0.300197, -0.300736, -0.363447, 1.44072])

    names.append("LShoulderRoll")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [0.298451, 0.312414, 0.316482, 1.24704, 1.24337, 1.23506, 1.23648, 1.23952, 1.23648, 1.24319, -0.0750492,
         -0.0653032, 0.114485, 0.215601])

    names.append("LWristYaw")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append([-0.00698132, -0.015708, 0.009239, -1.59378, -1.59267, -1.24433, -1.57769, -1.25507, -1.2585, -1.26482,
                 0.197222, 0.197679, -0.47319, 0.0984275])

    names.append("RAnklePitch")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-0.348279, -0.174185, -0.171502, -0.164981, -0.167552, -0.404916, -0.161303, -0.407489, -0.40182, -0.167108,
         -0.172115, -0.395586, 0.0789718])

    names.append("RAnkleRoll")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append([0, 0.0482817, 0.0519815, 0.0605263, 0.0610865, 0.0611668, 0.0608167, 0.0608167, 0.0605905, 0.0604224,
                 0.0603441, 0.0609399, 0.110732])

    names.append("RElbowRoll")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [1.00705, 0.946649, 1.27002, 1.26547, 1.35748, 1.26463, 1.34772, 1.27133, 1.35423, 1.33495, 1.31867, 1.32496,
         1.31337, 0.42031])

    names.append("RElbowYaw")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [1.38754, 1.37368, -0.459238, -0.458732, 1.3189, -0.390214, 1.3137, -0.384081, 1.4671, 0.161477, 0.160371,
         1.54074, 1.52927, 1.20332])

    names.append("RHand")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [0.26, 0.261572, 0.262901, 0.267093, 0.26883, 0.274328, 0.265166, 0.265166, 0.265166, 0.265166, 0.265166,
         0.265166, 0.270586, 0.291594])

    names.append("RHipPitch")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-0.447708, -0.211993, -0.208401, -0.20735, -0.204204, -1.11177, -0.203015, -1.10729, -1.10729, -0.176278,
         -0.179532, -1.10174, 0.12602])

    names.append("RHipRoll")
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [-0.00049019, -0.0546389, -0.0584451, -0.067236, -0.0680678, -0.0683314, -0.0675905, -0.0675905, -0.0675631,
    ...
    times.append([0, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append(
        [0.696828, 0.363927, 0.363926, 0.362414, 0.359538, 1.43117, 0.358737, 1.42616, 1.42616, 0.415388, 0.418919,
         1.43093, -0.0905938])

    names.append("RShoulderPitch")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append([0.244346, 0.908001, 0.669714, 0.673362, -0.307077, 0.610288, -0.297753, 0.608492, 0.0943403, 0.0903883,
                 0.0956723, -0.298265, -0.293671, 1.4391])

    names.append("RShoulderRoll")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append([-0.298451, -0.314782, -1.25623, -1.25512, -1.25141, -1.24295, -1.24338, -1.24876, 0.0713389, 0.0563975,
                 0.0313276, 0.0705488, 0.0609141, -0.223964])

    names.append("RWristYaw")
    times.append([0, 0.76, 1.56, 2.36, 3.16, 3.96, 5.16, 6.36, 7.56, 8.36, 9.56, 10.76, 11.56, 12.76])
    keys.append([0.00698132, 0.00836283, 1.6006, 1.5994, 1.2422, 1.5775, 1.25662, 1.56129, 0.149215, 0.154147, 0.156871,
